...
if __name__ == "__main__":
    ...
    staging_table_ref = client.dataset(dataset_id).table(staging_table_name)
                ...
                if value_at_x_y_day != -1.0:
                    ...
                    if (tracker == batch_size):
                        ...
                        if insert_mode:
                            ...
                            errors = client.insert_rows(staging_table, streaming_inserts)
                            if errors:
                                print(f"Encountered errors while streaming data: {errors}")
